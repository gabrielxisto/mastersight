    ...
    return (
        <Sidebar collapsible="icon" {...props}>
            ...
            <SidebarContent className="mt-3 overflow-hidden">
                <SidebarMenuButton 
                    onClick={() => router.navigate({ to: "/company/", search: { id: company.id } })}
                    className="ml-2.5" 
                    tooltip={"Início"}
                >
                    <House />
                ...
                <SidebarMenuButton 
                    onClick={() => router.navigate({ to: "/company/settings/", search: { id: company.id } })}
                    className="ml-2.5" 
                    tooltip={"Início"}
                >
                    <Settings2 />
            ...
            <SidebarFooter>
                <NavUser user={user || { name: "Gabriel Xisto", email: "gsxisto@gmail.com", image: "/avatars/shadcn.jpg" }} />
            </SidebarFooter>
            <SidebarRail />
        </Sidebar>
    )
