      ...
      <DialogContent className="sm:max-w-[26.56rem]">
        <form className="flex flex-col gap-6" onSubmit={onSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Tem certeza que deseja deletar o usuário <b className="uppercase">{data?.name}</b>? Esta ação não pode ser desfeita.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4">
            <div className="grid gap-3">
              ...
              <Input 
                ...
                name="id" 
                required 
                placeholder="Insira o ID do usuário para confirmar"
