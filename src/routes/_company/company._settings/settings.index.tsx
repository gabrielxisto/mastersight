...
import { formatCnpj } from '@/lib/formater';
...
function SettingsComponent() {
  ...
  function handleSubmit(data: CompanyFormValues) {
    api.post('/companies/update', {
      ...
      toast(messages.success["company-infos-updated"]);
  ...
  useEffect(() => {
    setIsDisabled(watched.name === defaultValues.name &&
    ...
    >
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className='space-y-8'>
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Este nome será exibido para todos que possuirem algum contato com a empresa.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Este CNPJ será exibido para todos que possuirem algum contato com a empresa.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Esta informação não irá impactar no funcionamento ou visualização da sua empresa.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <Button className={isDisabled ? "opacity-80 cursor-default" : ""} type='submit' disabled={isDisabled}>Salvar</Button>
        </form>
      </Form>
    </ContentSection>
  )
