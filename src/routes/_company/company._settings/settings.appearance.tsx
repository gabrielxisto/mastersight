...
function AppearanceComponent() {
  ...
  useEffect(() => {
    ...
    setColor(defaultValues.color || "#000000");
  ...
  const saveImage = (file: File | null) => {
    ...
    api
      .post("/companies/upload-image", formData, {
  ...
  function handleSubmit(data: AppearanceFormValues) {
    api
      ...
      .then((response) => {
        ...
        toast.success(messages.success["company-appearance-updated"]);
  ...
  useEffect(() => {
    setIsDisabled(
      watched.color === defaultValues.color &&
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Esta cor será exibida para todos que possuirem algum contato
                    com a empresa.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
          ...
          <FormField
            ...
            render={() => (
              <FormItem>
                ...
                <FormDescription>
                  Esta imagem será exibida para todos que possuirem algum
